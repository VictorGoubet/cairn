...
- **The site's own preview is a static card**, `public/og.jpg` (1200x630, ~50 kB), generated by
  `make og-card` from `scripts/make-og-card.mjs`: the square logo stretched into a wide slot was
  what chat apps used to show. A shared *route* gets its own tile instead, drawn in the browser.
