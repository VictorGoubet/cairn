 ...
 * requests from the whole app funnel through a small queue here. A failing instance is retried
 * once on a community mirror before giving up: both are volunteer-run, neither owes us uptime.
 */
